...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--target-os=linux --prefix=/Users/luopan/Documents/ffmpeg-2.8.15/android/arm/x86 --arch=x86 --disable-doc --enable-shared --disable-static --disable-yasm --disable-asm --disable-symver --enable-gpl --disable-ffmpeg --disable-ffplay --disable-ffprobe --disable-ffserver --cross-prefix=/Users/luopan/opt/android-ndk-r14b/toolchains/x86-4.9/prebuilt/darwin-x86_64/bin/i686-linux-android- --enable-cross-compile --sysroot=/Users/luopan/opt/android-ndk-r14b/platforms/android-16/arch-x86/ --enable-small --extra-cflags='-Os -fpic -march=i686 -mtune=intel -mssse3 -mfpmath=sse -m32' --extra-ldflags=
prefix=/Users/luopan/Documents/ffmpeg-2.8.15/android/arm/x86
...
ARCH=c
INTRINSICS=none
CC=/Users/luopan/opt/android-ndk-r14b/toolchains/x86-4.9/prebuilt/darwin-x86_64/bin/i686-linux-android-gcc
CXX=/Users/luopan/opt/android-ndk-r14b/toolchains/x86-4.9/prebuilt/darwin-x86_64/bin/i686-linux-android-g++
AS=/Users/luopan/opt/android-ndk-r14b/toolchains/x86-4.9/prebuilt/darwin-x86_64/bin/i686-linux-android-gcc
LD=/Users/luopan/opt/android-ndk-r14b/toolchains/x86-4.9/prebuilt/darwin-x86_64/bin/i686-linux-android-gcc
DEPCC=/Users/luopan/opt/android-ndk-r14b/toolchains/x86-4.9/prebuilt/darwin-x86_64/bin/i686-linux-android-gcc
DEPCCFLAGS= $(CPPFLAGS)
DEPAS=/Users/luopan/opt/android-ndk-r14b/toolchains/x86-4.9/prebuilt/darwin-x86_64/bin/i686-linux-android-gcc
DEPASFLAGS= $(CPPFLAGS)
YASM=yasm
DEPYASM=yasm
AR=/Users/luopan/opt/android-ndk-r14b/toolchains/x86-4.9/prebuilt/darwin-x86_64/bin/i686-linux-android-ar
ARFLAGS=rcD
AR_O=$@
RANLIB=/Users/luopan/opt/android-ndk-r14b/toolchains/x86-4.9/prebuilt/darwin-x86_64/bin/i686-linux-android-ranlib -D
STRIP=/Users/luopan/opt/android-ndk-r14b/toolchains/x86-4.9/prebuilt/darwin-x86_64/bin/i686-linux-android-strip
CP=cp -p
LN_S=ln -s -f
CPPFLAGS= --sysroot=/Users/luopan/opt/android-ndk-r14b/platforms/android-16/arch-x86/ -isysroot /Users/luopan/opt/android-ndk-r14b/platforms/android-16/arch-x86/ -D_ISOC99_SOURCE -D_FILE_OFFSET_BITS=64 -D_LARGEFILE_SOURCE -Dstrtod=avpriv_strtod -DPIC -DZLIB_CONST
CFLAGS=  -Os -fpic -march=i686 -mtune=intel -mssse3 -mfpmath=sse -m32 -std=c99 -fomit-frame-pointer -fPIC -pthread -g -Wdeclaration-after-statement -Wall -Wdisabled-optimization -Wpointer-arith -Wredundant-decls -Wwrite-strings -Wtype-limits -Wundef -Wmissing-prototypes -Wno-pointer-to-int-cast -Wstrict-prototypes -Wempty-body -Wno-parentheses -Wno-switch -Wno-format-zero-length -Wno-pointer-sign -Os -fno-math-errno -fno-signed-zeros -fno-tree-vectorize -Werror=format-security -Werror=implicit-function-declaration -Werror=missing-prototypes -Werror=return-type -Werror=vla -Wformat -fdiagnostics-color=auto -Wno-maybe-uninitialized
CXXFLAGS=  -D__STDC_CONSTANT_MACROS
ASFLAGS=  -Os -fpic -march=i686 -mtune=intel -mssse3 -mfpmath=sse -m32 -fPIC -g
AS_C=-c
AS_O=-o $@
CC_C=-c
CC_E=-E -o $@
...
LD_PATH=-L
DLLTOOL=
WINDRES=/Users/luopan/opt/android-ndk-r14b/toolchains/x86-4.9/prebuilt/darwin-x86_64/bin/i686-linux-android-windres
DEPWINDRES=/Users/luopan/opt/android-ndk-r14b/toolchains/x86-4.9/prebuilt/darwin-x86_64/bin/i686-linux-android-gcc
DOXYGEN=doxygen
LDFLAGS=   --sysroot=/Users/luopan/opt/android-ndk-r14b/platforms/android-16/arch-x86/ -isysroot /Users/luopan/opt/android-ndk-r14b/platforms/android-16/arch-x86/ -Wl,--as-needed -Wl,-z,noexecstack -Wl,--warn-common -Wl,-rpath-link=libpostproc:libswresample:libswscale:libavfilter:libavdevice:libavformat:libavcodec:libavutil:libavresample
LDEXEFLAGS=
LDLIBFLAGS=
